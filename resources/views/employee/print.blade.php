        ...
        <table class="table-bg">
            ...
            <tbody>
                @foreach ($getRecord as $key => $value)
                    @php
                        ...
                        $totalPayment += $value->total_collected;
                        //$totalDue +=
                    @endphp
                    <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th colspan="1" style="text-align: center;">{{ number_format($totalInstallment, 2) }} Taka</th>
                    <th colspan="1" style="text-align: center;">{{ number_format($totalPayment, 2) }} Taka</th>
                    <th colspan="1" style="text-align: center;">
                        {{ number_format($totalDue = $totalInstallment - $totalPayment, 2) }} Taka</th>
                </tr>
            </tfoot>
        </table>
