                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <select name="year" class="form-control">
                                        <option {{ old('year') == 2023 ? 'selected' : '' }} value="2023">2023</option>
                                        <option {{ old('year') == 2024 ? 'selected' : '' }} value="2024">2024</option>
                                        <option {{ old('year') == 2024 ? 'selected' : '' }} value="2025">2025</option>
                                        <option {{ old('year') == 2024 ? 'selected' : '' }} value="2026">2026</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('amount') }}" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" value="{{ old('last_date') }}"
                                            placeholder="last_date" name="last_date">
                                    </div>
